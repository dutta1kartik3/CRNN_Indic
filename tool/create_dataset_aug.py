	...
	label=label.strip()
        ...
        for k in xrange(0,len(nva)):
            ...
            if cnt % 1000 == 0:
              ...
              cache = {}
              print('Written %d / %d' % (cnt, no_aug*nSamples))
...
gamma = createDataset(outputPath='./IMPRINT-Hindi-elastic-lmdb/', imagePathListFile='train.txt', parentDirofImages='', lookupFile='hindi_final_lookup.txt')
